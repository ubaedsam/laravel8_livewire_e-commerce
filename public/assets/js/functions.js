        ...
        $(document).on("click", ".tab-control .tab-control-item", function (ev) {
          ...
          if (!$(this).hasClass("active")) {
            ...
            _tab_active.find(".wrap-products .owl-item").each(function (index) {
              ...
              owl_item
                .attr("style", style + ";-webkit-animation-delay:" + String(delay) + "ms;" + "-moz-animation-delay:" + String(delay) + "ms;" + "-o-animation-delay:" + String(delay) + "ms;" + "animation-delay:" + String(delay) + "ms;")
