                    ...
                    <div class="panel-body">
                        ...
                        <form action="" class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="addProduct">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="file" placeholder="Product Image" class="input-file" multiple wire:model="images">
                                    @if($images)
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-1">
                                    <button type="button" class="btn btn-danger btn-sm" wire:click.prevent="remove({{ $key }})">Hapus</button>
                                </div>
                            </div>
                            @endforeach
                            <div class="form-group">
...
{{-- Untuk merubah tampilan form textarea --}}
@push('scripts')
    <script>
        $(function(){
            tinymce.init({
