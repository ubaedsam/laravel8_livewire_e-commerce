                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="saveSettings">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4">Phone2</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4">Map</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4">Twiter</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4">Pinterest</label>
                                <div class="col-md-4">
