                    ...
                    <div class="detail-media">
                        <div class="product-gallery" wire:ignore>
                          <ul class="slides">
                            ...
                            {{-- Menampilkan semua data gambar (banyak gambar) --}}
                            {{-- Satu data gambar pertama --}}
                            @php
                                                ...
                                                <div id="comment-20" class="comment_container"> 
                                                    ...
                                                    <div class="comment-text">
                                                        ...
                                                        <p class="meta"> 
                                                            ...
                                                            <time class="woocommerce-review__published-date" datetime="2008-02-14 20:00" >{{ Carbon\Carbon::parse($orderItem->review->created_at)->format('d F Y:i A') }}</time>
                                                        </p>
