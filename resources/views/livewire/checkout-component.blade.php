<main id="main" class="main-site">
    <style>
        .summary-item .row-in-form input[type="password"], .summary-item .row-in-form input[type="text"], .summary-item-payment-method{
            font-size: 13px;
            line-height: 19px;
                    ...
                    <div class="wrap-address-billing">
                        ...
                        <div class="billing-address">
                            ...
                            <p class="row-in-form">
                                ...
                                <input type="text" name="province" value="" placeholder="Your postal code" wire:model="province">
                                @error('province')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </p>
                    ...
                    <div class="col-md-12">
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                ...
                                <p class="row-in-form">
                                    <label for="zip-code">Province</label>
                                    <input type="text" name="province" value="" placeholder="Your postal code" wire:model="s_province">
                                    @error('s_province')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </p>
                ...
                <div class="summary-item payment-method">
                    ...
                    <div class="choose-payment-methods">
                        <label class="payment-method">
                            ...
                            <span class="payment-desc">Pesan Sekarang dengan membayar di tempat</span>
                        </label>
                        <label class="payment-method">
                    ...
                    {{-- membuat tampilan proses pembelian --}}
                    @if($errors->isEmpty())
