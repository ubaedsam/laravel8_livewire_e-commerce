			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
					...
					<div class="widget mercado-widget filter-widget price-filter">
						<h2 class="widget-title">Harga <span class="text-info">Rp. {{ $min_price }} - Rp. {{ $max_price }}</span></h2>
...
{{-- memunculkan data barang dengan harga yang di pilih --}}
@push('scripts')
	<script>
		...
		slider.noUiSlider.on('update',function(value){
			@this.set('min_price',value[0]); // harga paling rendah
			@this.set('max_price',value[1]); // harga paling tinggi
		})
	</script>
@endpush