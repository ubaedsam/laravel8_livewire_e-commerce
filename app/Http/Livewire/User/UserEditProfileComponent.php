...
{
    // Digunakan untuk mengupload gambar atau file
    use WithFileUploads;
    ...
    // Mengambil satu data user berdasarkan user yang login
    ...
    // Proses merubah data user dan profile
    public function updateProfile()
    {
        $user = User::find(Auth::user()->id);
        $user->name = $this->name;
        $user->save(); // Menyimpan data ke dalam tabel user
        ...
        $user->profile->save(); // Menyimpan data ke dalam profile
        session()->flash('message','Data profile berhasil diubah');
    }
